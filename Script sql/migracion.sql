...
SET IDENTITY_INSERT Corporativo.Application.TransactionTypes ON;
INSERT INTO Corporativo.Application.TransactionTypes (
    TransactionTypeID, TransactionTypeName, LastEditedBy
)
SELECT
    TransactionTypeID, TransactionTypeName, LastEditedBy
FROM WideWorldImporters.Application.TransactionTypes;
SET IDENTITY_INSERT Corporativo.Application.TransactionTypes OFF;
GO
...
SET IDENTITY_INSERT Corporativo.Purchasing.PurchaseOrders ON;
INSERT INTO Corporativo.Purchasing.PurchaseOrders (
...
SET IDENTITY_INSERT Corporativo.Purchasing.PurchaseOrders OFF;
GO
...
SET IDENTITY_INSERT Corporativo.Purchasing.PurchaseOrderLines ON;
INSERT INTO Corporativo.Purchasing.PurchaseOrderLines (
...
SET IDENTITY_INSERT Corporativo.Purchasing.PurchaseOrderLines OFF;
GO
...
SET IDENTITY_INSERT Corporativo.Warehouse.StockItemTransactions ON;
INSERT INTO Corporativo.Warehouse.StockItemTransactions (
...
SET IDENTITY_INSERT Corporativo.Warehouse.StockItemTransactions OFF;
GO
